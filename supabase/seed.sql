...
-- 1 org, 21 hierarchy levels, 7 users, 50 knowledge nodes, 10 edges.
-- ============================================================
...
-- ---------- 50 Knowledge Nodes ----------
-- ZONE 2: GLOBAL NODES (10) — injected for ALL users, bypass BFS, still run 5 checks
...
-- ORTHOPAEDICS NODES (15) — Priya's department
...
-- GENERAL MEDICINE NODES (8) — Ananya's department, NOT Priya's
...
-- CARDIOLOGY NODES (5) — NOT reachable by Ortho users
...
-- HOSPITAL-WIDE ADMIN NODES (4) — visible only to ADMIN L1
...
-- HIGH-DERIVABILITY NODES (5) — should be EXCLUDED by Check 5
...
('N-D03', 'supra', 'HL-GLOBAL', 'FACT', 'Normal Vital Sign Ranges Adult',
 'Normal adult vital signs: HR 60-100 bpm, BP 120/80 mmHg (normal), RR 12-20/min, SpO2 >95%, Temp 36.1-37.2C. Variations normal for age, activity, and medication.',
